    ...
    try {
        ...
        const otpResponse = await fetch(`${apiConfig.admin.baseUrl}/auth/submit-otp`, {
            ...
            body: JSON.stringify({
                ...
                mobile: '9807887878',
                user_type: 'customer',
                otp: '123456', // In production, this would come from user input
...
function renderProductsToPage(append = false) {
    ...
    const brandGrid = document.querySelector('.card-grid');
...
function createProductCard(product) {
    ...
    const imageUrl = product.images.thumbnail || 'assets/images/brands/new-smartphones-stand-row-showcase-store 1.png';
